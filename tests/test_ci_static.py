...
class CiStaticTest(unittest.TestCase):
    ...
    def test_ci_uploads_release_and_rpm_artifacts(self) -> None:
        ...
        self.assertIn("uses: actions/checkout@de0fac2e4500dabe0009e67214ff5f5447ce83dd", workflow)
    ...
    def test_tag_release_workflow_publishes_verified_assets(self) -> None:
        ...
        self.assertIn("uses: actions/checkout@de0fac2e4500dabe0009e67214ff5f5447ce83dd", workflow)
        self.assertIn("uses: actions/setup-python@a309ff8b426b58ec0e2a45f0f869d46889d02405", workflow)
        self.assertIn("persist-credentials: false", workflow)
        self.assertIn("uses: actions/upload-artifact@043fb46d1a93c77aae656e7c1c64a875d1fc6a0a", workflow)
        self.assertIn("runs-on: ubuntu-24.04", workflow)
        self.assertNotIn("runs-on: ubuntu-latest", workflow)
