...
class AppletStaticTest(unittest.TestCase):
    ...
    def test_applet_exposes_auto_paste_title_marker(self) -> None:
        ...
        self.assertIn("_spawnKeyboardWhenClipboardReady: function(args, followUpArgs, expectedClipboardText, deadlineMs, expectedTargetWindow)", source)
    ...
    def test_text_polishing_presets_build_effective_prompt(self) -> None:
        ...
        self.assertIn("without changing meaning", schema["post-process-preset-help-minimal"]["description"])
    ...
    def test_text_output_is_hardened_before_keyboard_typing(self) -> None:
        ...
        self.assertIn("_spawnKeyboardAfterFocus: function(args, followUpArgs, expectedClipboardText, expectedTargetWindow) {", source)
    ...
    def test_applet_can_reinsert_last_transcript_with_current_output_mode(self) -> None:
        ...
        self.assertIn("return this._spawnKeyboardAfterFocus(args, followUpArgs, expectedClipboardText, expectedTargetWindow);", source)
        self.assertIn("return false;", source)
        self.assertIn("return true;", source)
