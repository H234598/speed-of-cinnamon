...
class AppletStaticTest(unittest.TestCase):
    ...
    def test_external_api_voice_menu_opens_env_file_for_configuration(self) -> None:
        ...
        self.assertIn('migrated += suffix + "OPENAI_COMPATIBLE_API_KEY=" + legacyApiKey + "\\n";', source)
    ...
    def test_recording_start_invalidates_stale_background_callbacks(self) -> None:
        ...
        self.assertIn("return inputSourceRefreshCleanupSucceeded && alarmMenuRefreshCleanupSucceeded && alarmActionCleanupSucceeded && alarmCheckCleanupSucceeded && benchmarkCleanupSucceeded && settingsTransferCleanupSucceeded && setupDiagnosticsCleanupSucceeded && doctorCleanupSucceeded;", helper_block)
