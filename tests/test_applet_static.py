...
class AppletStaticTest(unittest.TestCase):
    ...
    def test_applet_exposes_auto_paste_title_marker(self) -> None:
        ...
        self.assertIn("Built-in presets require the title marker", schema["auto-paste-window-title"]["tooltip"])
        self.assertIn("custom strings are title-only", schema["auto-paste-window-title"]["tooltip"])
