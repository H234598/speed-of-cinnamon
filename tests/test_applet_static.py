...
class AppletStaticTest(unittest.TestCase):
    ...
    def test_text_polishing_supports_openai_compatible_api(self) -> None:
        ...
        self.assertIn('this.settings.bindProperty(Settings.BindingDirection.IN, "openai-compatible-model", "openaiCompatibleModel", this._onVoiceBackendSettingsChanged, null);', source)
        self.assertNotIn('this.settings.bindProperty(Settings.BindingDirection.IN, "openai-compatible-model", "openaiCompatibleModel", this._onTextModelSettingsChanged, null);', source)
    ...
    def test_settings_export_uses_stdin_not_process_arguments_for_snapshot(self) -> None:
        ...
        self.assertIn("_settingsSnapshotInputOption: function()", source)
    ...
    def test_applet_restores_target_window_before_clipboard_paste(self) -> None:
        ...
        self.assertIn('if (!this._targetXWindowMatchesSnapshot(expectedTargetWindow)) {', source)
    ...
    def test_applet_tracks_non_text_payload_fingerprint_beyond_targets(self) -> None:
        ...
        self.assertIn("for (let target of nonTextTargets.slice().sort()) {", source)
        self.assertIn('return fingerprints.join("|");', source)
    ...
    def test_auto_paste_matches_identity_markers_with_bounded_short_tokens(self) -> None:
        ...
        self.assertIn('activeTitle = this._shortMenuText(activeTitle, 160).toLowerCase();', source)
