...
class AppletStaticTest(unittest.TestCase):
    ...
    def test_spawn_callbacks_ignore_removed_applet(self) -> None:
        ...
        self.assertIn("this._registerProcess(process, generation)", source)
        self.assertIn("if (this.appletRemoved || this.spawnGeneration !== generation", source)
    ...
    def test_tools_install_menu_has_functional_setup_buttons(self) -> None:
        ...
        self.assertIn("unthis._connectSafe(installOllamaRuntime, \"activate\", () => this._uninstallOllamaRuntime());", source)
