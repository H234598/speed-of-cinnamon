...
class AppletStaticTest(unittest.TestCase):
    ...
    def test_text_polishing_supports_openai_compatible_api(self) -> None:
        ...
        self.assertIn("this.maintenanceMenuItem.menu.addMenuItem(this.openAiFlexProcessingItem);", source)
    ...
    def test_history_entries_can_be_copied_or_inserted(self) -> None:
        ...
        storage_index = source.index("this.maintenanceMenuItem.menu.addMenuItem(this.transcriptStorageItem);")
        flex_index = source.index("this.maintenanceMenuItem.menu.addMenuItem(this.openAiFlexProcessingItem);")
        self.assertLess(storage_index, flex_index)
        self.assertIn("_allHistoryArgs: function()", source)
        self.assertIn('return [this._cliCommand(), "transcripts-document", "--limit", "1000", "--json"];', source)
        ...
        self.assertIn('this._setStatus("processing", _("Preparing transcript document..."), this.lastTranscript)', source)
        self.assertIn('this._openFile(path, _("Opened transcript document: ") + String(payload.transcripts || 0));', source)
    ...
    def test_cleanup_can_be_previewed_before_deleting_files(self) -> None:
        ...
        self.assertIn('this.transcriptStorageItem = new PopupMenu.PopupSubMenuMenuItem(_("Store transcripts: 500"))', source)
        self.assertIn("_populateTranscriptStorageMenu: function()", source)
        self.assertIn('_("Keep a maximum of ") + String(limit) + _(" transcript files")', source)
        self.assertIn('"--title=Store transcripts"', source)
