...
class AppletStaticTest(unittest.TestCase):
    ...
    def test_applet_exposes_auto_paste_title_marker(self) -> None:
        ...
        self.assertIn("_spawnKeyboardWhenClipboardReady: function(args, followUpArgs, expectedClipboardText, deadlineMs)", source)
    ...
    def test_text_output_is_hardened_before_keyboard_typing(self) -> None:
        ...
        self.assertIn("_spawnKeyboardAfterFocus: function(args, followUpArgs, expectedClipboardText) {", source)
    ...
    def test_applet_can_reinsert_last_transcript_with_current_output_mode(self) -> None:
        ...
        self.assertIn('let submitWithReturn = autoPasteEnter && method === "clipboard-paste" && canPasteWithKeyboard;', source)
        ...
        self.assertIn("return this._spawnKeyboardAfterFocus(args, followUpArgs, expectedClipboardText);", source)
        self.assertIn("return false;", source)
        self.assertIn("return true;", source)
