...
EXPORTABLE_SETTINGS: dict[str, tuple[type, Any]] = {
    ...
    "auto-backup-directory": (str, ""),
    "auto-backup-config": (bool, True),
    "auto-backup-transcripts": (bool, True),
    "auto-backup-audio": (bool, False),
    "auto-backup-encryption": (str, "keyring"),
    "auto-backup-on-success": (bool, True),
    "auto-backup-config-debounce-seconds": (int, 30),
    "auto-backup-retry-count": (int, 3),
    "auto-backup-retry-delay-seconds": (int, 30),
    "auto-backup-notify-success": (bool, False),
    "auto-backup-notify-error": (bool, True),
...
_ALLOWED_SETTING_TEXT_VALUES: dict[str, frozenset[str]] = {
    ...
    "auto-backup-encryption": frozenset({"keyring", "passphrase", "off"}),
    "auto-backup-retention-mode": frozenset({"manual"}),
